    ...
    <main className="container mx-auto max-w-7xl px-4 py-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Use the vehicle selector to differentiate models by chassis, body, and engine. Then search for parts that fit.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Vehicle and Parts Lookup</CardTitle>
          </CardHeader>
          <CardContent>
            <EnhancedPartsLookup vehicles={vehicles} />
          </CardContent>
        </Card>
      </div>
    </main>
